...
params.F_ext_min_for_mass_opt = 1000; params.M_max_for_Fext_opt = 30.0;
...
x0 = (lb+ub)/2; % Midpoint as initial guess
...
lbfgs_custom_options.GradientTolerance = 1e-3; % For augmented Lagrangian gradient
lbfgs_custom_options.StepTolerance = 1e-5;
lbfgs_custom_options.FunctionTolerance = 1e-5;
